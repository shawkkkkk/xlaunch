...
In X account settings, enable the automated-account label for **@launchonx_** and connect **@ShayanelH** as its managing account.
...
11. Test an @launchonx_ reply command end-to-end: mention → X verification → wallet proof → signature → launch → final bot reply.
...
- @launchonx_ is labeled as automated and linked to @ShayanelH.
