const sections = [
  ...
  },
  {
    id: "launch",
    title: "LAUNCHING",
    body: "Paste an X post or launch from an @launchonx_ reply. Choose Pump.fun, StonkFun or Pons, configure the venue's available options, review the canonical source and sign the actual transaction with your wallet.",
  },
  {
    id: "canonical",
  ...
  },
  {
    id: "social",
    title: "X BOT",
    body: "Reply directly under the source X post and mention @launchonx_ with an explicit venue. The parent post becomes the source automatically. X OAuth and wallet signatures protect social launches from command hijacking.",
  },
  {
    id: "profile",
